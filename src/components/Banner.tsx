      ...
      <Container>
        <Row className="align-items-center">
          <Col xs={12} md={6} xl={7}>
            ...
            <p>
             Hi there, I am a software engineer based on developing software products include Web applications and Mobile Apps. I am a long-time learner and open-source enthusiast
            </p>
